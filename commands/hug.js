...
module.exports = {
    ...
    async execute(message, args, client) {
        ...
        message.channel.send({content: `${target ? `${target} was hugged by ${message.author}!` : `${message.author} seems lonely. How about I help with this!`}`, embed: { thumbnail: {url: url}}});
    }
}
