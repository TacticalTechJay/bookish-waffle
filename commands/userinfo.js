...
module.exports = {
    ...
    async execute(message, args, client) {
        ...
        let user = message.mentions.members.first() || message.guild.members.cache.get(args[0]) || message.guild.members.cache.find(m => m.user.username.includes(args.join(" "))) || await client.users.fetch(args[0]);
        const embed = new MessageEmbed()
            .setColor(0x12db37)
